...
<div class="container-fluid">
  <div class="row tops">
    <div class="col-6 padd">
      <div class="row">
        <div class="col-6"">
          <h3>¿Qué es hosting?</h3>
          <hr>
        </div>
      </div>
      <div class="row">
        <div class="col-11">
          <p class="l-g">Las páginas web se guardan (“alojan”) en un ordenador accesible públicamente (servidor). Algunas páginas web requieren un servidor dedicado exclusivamente para ellas. Otras pueden compartir servidor con otras páginas webs. Este espacio de almacenamiento, y las características que incluye, componen tu plan de hospedaje web.</p>
          <p class="inf-1 top">Encuentra los mejores paquetes con las mejores características ...</p>
          <h5 class="inf-2">No hay riesgo, si cancelas a momento.</h5>
          <div class="top2">
            <span class="inf-3">1</span><span class="inf-4">er</span><span class="inf-5"> mes para hacerlo</span><br>
          </div>
          <button class="btn btn-danger top3" onclick="location.href='InfoHostingsClient?type=0'">Ver todos los paquetes</button>
        </div>
      </div>
    </div>
    <div class="col-6">
      <img src="../../../Data/imgs/host1.svg" class="host-1">
      <img src="../../../Data/imgs/host2.jpg" class="host-2">
    </div>
  </div>
</div>
<div class="title text-center">
  <div class="over">
    <br><br><br><h1>¡Toma la mejor opción que se adapte a tus necesidades!</h1>
  </div>
</div>
<div class="container-fluid cont">
  <div class="row text-center justify-content-between">
    <div class="col-3 box fix-1">
      <div class="row">
        <div class="col-12">
          <img src="../../../Data/imgs/medal3.jpg">
          <h5>CHIBCHA PLATINO</h5>
          <p>Hosting compartido y económico</p>
          <hr>
          <p>Desde</p>
          <h4 class="top2">$ <?php echo($hostingDAO->getMinorHosting('Platino')); ?>/mes</h4>
          <button class="btn btn-success top" onclick="location.href='InfoHostingsClient?type=Platino'">Obten más información</button>
        </div>
      </div>
    </div>
    <div class="col-3 box">
      <div class="row">
        <div class="col-12">
          <img src="../../../Data/imgs/medal2.jpg">
          <h5>CHIBCHA PLATA</h5>
          <p>Hecho para que sea rápido y fácil</p>
          <hr>
          <p>Desde</p>
          <h4 class="top2">$ <?php echo($hostingDAO->getMinorHosting('Plata')); ?>/mes</h4>
          <button class="btn btn-success top" onclick="location.href='InfoHostingsClient?type=Plata'">Obten más información</button>
        </div>
      </div>
    </div>
    <div class="col-3 box fix-3">
      <div class="row">
        <div class="col-12">
          <img src="../../../Data/imgs/medal1.jpg">
          <h5>CHIBCHA ORO</h5>
          <p>Conveniente y poderoso</p>
          <hr>
          <p>Desde</p>
          <h4 class="top2">$ <?php echo($hostingDAO->getMinorHosting('Oro')); ?>/mes</h4>
          <button class="btn btn-success top" onclick="location.href='InfoHostingsClient?type=Oro'">Obten más información</button>
        </div>
      </div>
    </div>
  </div>
