...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"rotate",prev:"",next:"",duration:20*100,delay:40*100,width:640,height:360,autoPlay:true,autoPlayVideo:false,playPause:true,stopOnHover:false,loop:false,bullets:1,caption:true,captionEffect:"parallax",controls:true,controlsThumb:["data1/tooltips/1.png", "data1/tooltips/2.png", "data1/tooltips/3.png", "data1/tooltips/4.png"],responsive:2,fullScreen:false,gestures:2,onBeforeStep:0,images:0});